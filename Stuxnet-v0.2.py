...
#Envoi du nom
groupname = "Stuxnet - v0.2" #mettez ici le nom de votre equipe
...
while True:
    ...
    if order == "SET":
        ...
        order = stuxnet.find_smart_move()[1]
        ...
        print "order", order[0], order[1], order[2], order[3], order[4], order[5], order[6]


        send(sock, order[0], order[1], order[2], order[3], order[4], order[5], order[6])
        """
