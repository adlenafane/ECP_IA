...
class Board():
    ...
    def score(self):
        ...
        return (k + 40*self.our_number() - 10*self.ennemy_number()  - self.sum_min_distance_us_human_delta() + self.sum_min_distance_us_ennemy_delta() + self.sum_min_distance_ennemy_human_delta() + 20.0*self.our_number()/len(self.our_positions()))
